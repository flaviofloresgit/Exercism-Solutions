...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    product_value = temperature * neutrons_emitted
    
    if temperature < 800 and neutrons_emitted > 500 and product_value < 500000:
        return True
    elif temperature >= 800 or neutrons_emitted <= 500 or product_value >= 500000:
        return False
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if actual_value < threshold * 0.9:
        return 'LOW'
    elif threshold * 0.9 <= actual_value <= threshold * 1.1:
        return 'NORMAL'
    else:
        return 'DANGER'